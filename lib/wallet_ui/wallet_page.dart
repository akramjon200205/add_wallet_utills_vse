...
import 'package:add_wallet/utills/price-model.dart';
        ...
        title: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: const DecorationImage(
              image: AssetImage('assets/imd_user.png'),
              fit: BoxFit.cover,
            ),
          ),
        ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        border: Border.all(
                            color: const Color(0xffc8e7a6), width: 6),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        border: Border.all(
                            color: const Color(0xffffecc5), width: 6),
                        borderRadius: BorderRadius.circular(35),
                      ),
                      child: Image.asset(
                        'assets/ic_dots.png',
